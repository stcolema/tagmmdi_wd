...
my_dir <- "~/Desktop/TestMDIcall/Orre/Orre/"

model_runs_files <- list.files(my_dir, full.names = TRUE, include.dirs = FALSE)
...
write.csv(my_df, "./KNN_TL_comp/Orre_perf.csv")