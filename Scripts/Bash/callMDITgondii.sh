...
script="callMDITGondiiModelOnly.R";
...
application="Rscript ${script_dir}${script} --data_file ${data_file} --R ${R} --thin ${thin} --seed ${seed} --K ${K} --n_chains ${n_chains} --save_dir ${save_dir}";
