...
sample_file <- paste0(save_dir, "mcmcMDItestdataSeed", seed, ".rds")
plot_file <- paste0(save_dir, "mdiTestDaraPhisSeed", seed, ".png")
...
# row_order <- findOrder(test_data[[1]])
# td_1_df <- prepDataForggHeatmap(test_data[[1]], row_order = row_order, col_order = seq(1, 100))
# td_2_df <- prepDataForggHeatmap(test_data[[2]], row_order = row_order, col_order = seq(1, 100))
# td_3_df <- prepDataForggHeatmap(test_data[[3]], row_order = row_order, col_order = seq(1, 100))

# td_1_df$Dataset <- 1
# td_2_df$Dataset <- 2
# td_3_df$Dataset <- 3

#td_df <- rbind(td_1_df, td_2_df, td_3_df)
