...
burn <- R * 0.2
mcmc_semi <- tagmReDraft::processMCMCChain(mcmc_semi, burn)
mcmc_un <- tagmReDraft::processMCMCChain(mcmc_un, burn)
...
annotatedHeatmap(psm_semi_1, gen_data$group_IDs, col_pal = simColPal(), my_breaks = defineBreaks(simColPal(), lb = 0))
annotatedHeatmap(psm_semi_2, gen_view_2$labels, col_pal = simColPal(), my_breaks = defineBreaks(simColPal(), lb = 0))
annotatedHeatmap(psm_semi_3, gen_view_3$labels, col_pal = simColPal(), my_breaks = defineBreaks(simColPal(), lb = 0))

annotatedHeatmap(psm_un_1, gen_data$group_IDs, col_pal = simColPal(), my_breaks = defineBreaks(simColPal(), lb = 0))
annotatedHeatmap(psm_un_2, gen_view_2$labels, col_pal = simColPal(), my_breaks = defineBreaks(simColPal(), lb = 0))
annotatedHeatmap(psm_un_3, gen_view_3$labels, col_pal = simColPal(), my_breaks = defineBreaks(simColPal(), lb = 0))
...
phi_df <- mcmc_semi$phis |>
  ...
  dplyr::mutate(Iteration = seq(mcmc_semi$burn + mcmc_semi$thin, mcmc_semi$R, mcmc_semi$thin)) |> 
